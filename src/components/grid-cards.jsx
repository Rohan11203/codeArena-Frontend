  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <div className="flex -space-x-10">
        {/* Left Card */}
        <motion.div
          className="w-60 h-80 opacity-60 bg-blue-900 rounded-xl shadow-lg shadow-blue-900/40 pt-6 pl-2"
          variants={cardHoverEffect}
          animate={isMiddleHovered ? cardHoverEffect.hover("left") : cardHoverEffect.initial("left")}
        >
          <h2 className="text-2xl text-white font-semibold">Single Player</h2>
        ...
        {/* Middle Card */}
        <motion.div
          className="w-70 h-80 bg-blue-700 rounded-xl shadow-lg shadow-blue-700/40 pt-6 pl-2 z-10"
          variants={cardHoverEffect}
        ...
        >
          <h2 className="text-2xl text-white font-semibold">Multi Player</h2>
        ...
        >
          <h2 className="text-2xl text-white font-semibold">Quizes</h2>
