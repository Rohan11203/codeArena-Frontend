            ...
            <div className="w-1/3 pr-2 flex justify-end space-x-4">
              ...
              {isAuth && (
                <div className="dropdown dropdown-bottom z-30">
                  <div tabIndex={0} role="button" className=" px-5 py-2.5 text-sm font-bold text-white bg-gradient-to-r from-blue-800 to-blue-400 rounded-lg hover:from-blue-500 hover:to-blue-500 transition-all duration-200 shadow-lg shadow-purple-900/20">
                    Play 
                  </div>
                  <ul
                    tabIndex={0}
